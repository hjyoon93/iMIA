...
def args_parser():
    ...
    parser.add_argument('--local_ep', type=int, default=10, help="the number of local epochs: E") #it was originally 10
    ...
    parser.add_argument('--kernel_num', type=int, default=5, help='number of each kind of kernel')
    ...
    parser.add_argument('--iid', action='store_true', default='iid', help='whether i.i.d or not')
